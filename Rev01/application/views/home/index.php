                    ...
                    <nav class="navbar navbar-default" id="mainNav">
                        <div class="navbar-header">
                            ...
                            <div class="logo">
                                <a class="navbar-brand js-scroll-trigger logo-header" href="#">
                                    <img src="assets/images/logo luwe 02.png" width="100" height="65" alt="">
                                </a>
                            </div>
                        </div>
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="login_color" href="#">Login</a></li>
                            </ul>
                        </div>
                        <!-- end nav-collapse -->
                    </nav>
            ...
            <div class="banner-static">
                <div class="banner-text">
                    <div class="banner-cell">
                        ...
                        <img src="assets/images/logo bunder.png" width="450" height="450" alt="">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <div class="about-images">
                        <img class="about-main" src="assets/images/gambarhome1.png" alt="About Main Image">
                    </div>
                </div>
            </div>
            <!-- end col -->
                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                            <div class="item item-type-zoom">
                                <a href="home_menu.html" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                            Lalapan Khas Malang
                                            <div class="line"></div>
                                            <div class="dit-line">Ciri Khas kuliner malang, dengan paduan sambal
                                                tomat dengan tempe dan tahu yang nikmat</div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                    ...
                    <div class="team-box">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a data-toggle="modal" data-target="#exampleModal" href="#"><img src="images/banner gopay1-01.png" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Dana Promo Ultah</h3>
                                        <p>..</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <h5>Kode Promo</h5>
                                                <h4>GOPAYDAY <span>Kuota 200/hari</span></h4>
                                                <h4>GOPAYMANTAP <span>Kuota 50/hari</span></h4>
                                                <h4>GOPAYBOSQUE <span>Kuota 10/hari</span></h4>
                                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="images/SOPI2-01.png" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Shopee Brand Day</h3>
                                        <p>..</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="images/dana2-01.png" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Gopay 10th</h3>
                                        <p>..</p>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="images/ovovov-01.png" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Ovo 30th</h3>
                                        <p>..</p>
                    ...
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                ...
                                <div class="blog-dit">
                                    <h1>Billie Halim</h1>
                                    <p>Bakpia mangkok malang enak disajikan saat berbuka puasa
                                    </p>
                    ...
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                ...
                                <div class="blog-dit">
                                    <h1>Harya Grahila</h1>
                                    <p>Bakso presiden maknyossssss...
                                    </p>
                                    <h4>5 DESEMBER, 2020</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
